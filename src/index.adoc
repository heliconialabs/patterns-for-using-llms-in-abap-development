...
This pattern is a combination of sandbox and git. This setup is know from almost all other languages where developers usually write code
...
In this pattern, it is expected that developers can work mock test data and other resources. It is expected that developers can automate
